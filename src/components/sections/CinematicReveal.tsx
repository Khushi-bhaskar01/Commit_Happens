    ...
    >
      ...
      >
        ...
        <div className="pointer-events-none absolute right-6 top-28 z-10 flex max-w-[46ch] flex-col items-end gap-5 text-right md:right-12 md:top-32">
          <EyebrowBadge>HACK SPRINT // CONTINUOUS SESSION</EyebrowBadge>
          {/* <div className="relative self-stretch">
            <h2
              ref={h2IronManRef}
              className="font-display text-4xl font-bold leading-[0.98] tracking-tighter text-foreground md:text-6xl lg:text-7xl uppercase"
            >
              The New
              <br />
              <span className="text-accent drop-shadow-[0_0_15px_rgba(8,191,124,0.4)]">Doctrine.</span>
            </h2>
          </div> */}
          <p className="max-w-[42ch] font-sans text-sm font-medium leading-relaxed text-zinc-300 md:text-base">
            16 May 2026. The terminal is your only witness.
          </p>
        </div>
        ...
        <div className="pointer-events-none absolute right-6 top-20 z-10 flex items-center gap-3 md:right-10 md:top-24">
          ...
          <span
            aria-hidden
            className="inline-block h-1.5 w-1.5 rounded-full bg-accent shadow-[0_0_10px_rgba(255,95,31,0.85)]"
          />
        </div>
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-0 z-10">
          ...
          <div className="mx-6 flex items-center justify-between pb-4 font-mono text-[10px] uppercase tracking-[0.28em] text-zinc-500 md:mx-10">
            <span>COMMIT HAPPENS // ARCHIVE</span>
            <span>CENTRAL AI // PLAYBACK</span>
